...
$$\large{lm\_1} :\large{\widehat{\text{Tree ring z-score}}} = -0.3411 + 1.2732  \text{Europe temp index}$$

$$\large{lm\_2} :\large{\widehat{\text{Tree ring z-score}}} = -0.3424 + 1.2726  \text{Europe temp index} + 0.1212 \text{Eruption}$$
