...
We first plotted the world map of Active Volcanoes(erupted before) with tectonic plate boundaries overlaid. 
...
Above shows the plot zoomed into the Ring Of Fire with volcanoes running along the 
boundaries. 
