...
## Which VEI rating eruptions are most likely?
...
```{r tile-plot, fig.align="center", fig.width = 13, warning = FALSE, message = FALSE, results='asis'}
...
```{r glm, fig.cap = "Goodness of fit measure for VEI and duration"}
...
```{r jcbplot, message=FALSE, warning=FALSE, echo=FALSE, fig.align="center", fig.width=14, fig.height = 10, fig.cap = "Eruption duration across the range of tectonic settings"}
...
```{r jfb1, message=FALSE, warning=FALSE, echo=FALSE, fig.height=8, fig.align="center", fig.width=12, fig.cap = "The high or low frequncies associated with the range of tectonic settings"}
# keep
bhftectplot <- btect0 %>% 
  filter(!is.na(tectonic_settings)) %>%
  ggplot() + 
